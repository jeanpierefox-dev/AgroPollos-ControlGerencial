          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 sticky top-8">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button
                  type="submit"
                  className={`${isEditing ? 'w-2/3' : 'w-full'} bg-emerald-600 text-white font-bold py-3 rounded-xl hover:bg-emerald-700 transition-colors shadow-lg shadow-emerald-200 uppercase tracking-widest text-xs`}
                >
